...
final authRepositoryProvider = Provider<UserAuthRepository>((ref) {
...
final userInformationProvider =
  ...
  final datasource = ref.watch(authRepositoryProvider);
...
class SignInNotifier extends StateNotifier<UserState> {
  ...
  Future<UserModel> signInWithEmailAndPassword(
    ...
    try {
      ...
      if (context.mounted) {
        CustomAlertDialog.showAlertDialog(context, 'No se pudo iniciar sesión',
            'Error: ${e.toString()}', null, null);
      }
      rethrow;
    }
  }
