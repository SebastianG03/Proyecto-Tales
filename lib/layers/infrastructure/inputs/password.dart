...
class Password extends FormzInput<String, PasswordError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == PasswordError.length)
      return 'Mínimo 6 caracteres y maximo 16';
    if (displayError == PasswordError.format)
      return 'Debe de tener letras mayúsculas, minúsculas y un número';
  ...
  PasswordError? validator(String value) {
    ...
    if (value.length < 6 || value.length > 16) return PasswordError.length;
