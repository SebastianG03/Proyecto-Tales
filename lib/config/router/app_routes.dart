...
import '../../layers/presentation/views/views.dart';
...
class AppRoutes {
  ...
  static const String _updateAccountRoute = 'update_user/:user';
                        ...
                        builder: (context, state) {
                          return ChildScreen(
                            widget: UpdateUserView(
                                user: UserModel.fromJson(jsonDecode(state.pathParameters['user']!))),
                          );
                        },
                        routes: const [],
                      )
